function update_permission() {
    ...
    if ($("#cookie-settings").modal("hide"), Cookies.get("tracking") && (gaProperty = $(".site-ua").html(), disableStr = "ga-disable-" + gaProperty, -1 < document.cookie.indexOf(disableStr + "=true") && (window[disableStr] = !0), ga("create", gaProperty, "auto"), ga("set", "anonymizeIp", !0), ga("send", "pageview")), Cookies.get("targeting")) {
        var t = $(".site-fp").html();
...
$(function() {
    $(".vertical-tabs a").click(function() {
        ...
        e.preventDefault(), $("#cookie-settings").modal("show")
    })
});
